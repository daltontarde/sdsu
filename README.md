...
- **CS 150** - Introductory Computer Programming (3 units)
- **CS 150L** - Introductory Computer Programming Laboratory (1 unit)
- **CS 160** - Intermediate Computer Programming (3 units)
- **CS 160L** - Intermediate Computer Programming Laboratory (1 unit)
- **CS 210** - Data Structures (3 units)
- **CS 240** - Computer Organization (3 units)
...
- **CS 370** - Computer Architecture (3 units)
- **CS 450** - Introduction to Artificial Intelligence (3 units)
- **CS 460** - Algorithms (3 units)
- **CS 480** - Operating Systems (3 units)
- **CS 420** - Advanced Programming Languages (3 units)
- **STAT 550** - Applied Probability (3 units)

### Elective Courses (18 Units)

In consultation and with the approval of the adviser, 18 units of courses are required from courses listed under the following areas A, B, C, and D with no more than six units from area D.

#### A. Computer Systems
- **CS 470** - UNIX System Administration (3 units)
- **CS 530** - Systems Programming (3 units)
- **CS 532** - Software Engineering (3 units)
- **CS 545** - Introduction to Web Application Development (3 units)
- **CS 546** - Human Computer Interfaces (3 units)
- **CS 562** - Automata Theory (3 units)
- **CS 572** - Microprocessor Architecture (3 units)
- **CS 574** - Computer Security (3 units)
- **CS 576** - Computer Networks and Distributed Systems (3 units)
- **CS 578** - Wireless Networks (3 units)

#### B. Intelligent Systems
- **CS 549** - Machine Learning (3 units)
- **CS 553** - Neural Networks (3 units)
- **CS 556** - Robotics (3 units)
- **CS 559** - Computer Vision (3 units)
- **CS 561** - Deep Learning for Natural Language Processing (3 units)
- **CS 583** - 3D Game Programming (3 units)

#### C. Data Sciences
- **CS 503** - Scientific Database Techniques (3 units)
- **CS 514** - Database Theory and Implementation (3 units)
- **CS 537** - Programming for GIS (3 units)
- **CS 558** - Computer Simulation (3 units)
- **CS 577** - Principles and Techniques of Data Science (3 units)
- **CS 581** - Computational Linguistics (3 units)
- **CS 582** - Introduction to Speech Processing (3 units)

#### D. Special Courses
- **CS 496** - Experimental Topics (1-4 units)
- **CS 497** - Undergraduate Research Seminar (3 units)
- **CS 498** - Undergraduate Honors Thesis (3 units)
...
- **ENGL 250A** - Literature of the United States (3 units) or
- **ENGL 250B** - Literature of the United States (3 units) But not both.
- **ENGL 260A** - English Literature (3 units)
- **ENGL 260B** - English Literature (3 units)
- **RWS 200** - Rhetoric of Written Arguments in Context (3 units)

Three Units Selected from:
- **ENGL 220** - Introduction to Literature (3 units)
- **ENGL 280** - Introduction to Creative Writing (3 units)

- **C LT 270A** - World Literature (3 units) or
- **C LT 270B** - World Literature (3 units) But not both.
...
- **ENGL 220** - Introduction to Literature (3 units)
- **ENGL 280** - Introduction to Creative Writing (3 units)
- **C LT 270A** - World Literature (3 units)
- **C LT 270B** - World Literature (3 units)
...
- **ENGL 510A** - Earlier Histories of British and American Literature (3 units) Must include at least three units
- **ENGL 510B** - Later Histories of British and American Literature (3 units)
- **ENGL 522** - Literature of the United States, 1800-1860 (3 units) Must include at least three units
- **ENGL 523** - Literature of the United States, 1860-1920 (3 units)
- **ENGL 524** - Literature of the United States, 1920-1960 (3 units)
- **ENGL 525** - Literature of the United States, 1960 to Present (3 units)
- **ENGL 527** - Genre Studies (3 units)
- **ENGL 528** - Authors (3 units)
- **ENGL 530** - Chaucer (3 units) Must include at least three units
- **ENGL 533** - Shakespeare (3 units) Must include at least three units
- **ENGL 534** - Study of Shakespeare (3 units) Must include at least three units
- **ENGL 536** - British Literary Periods, Beginnings to 1660 (3 units) Must include at least three units
- **ENGL 537** - Milton (3 units) Must include at least three units
- **ENGL 540A** - English Fiction (3 units) Must include at least three units
- **ENGL 541A** - English Drama (3 units) Must include at least three units
- **ENGL 541B** - English Drama (3 units)
- **ENGL 543** - British Literary Periods, 1800-1900 (3 units)
- **ENGL 544** - British Literary Periods, 1900-Present (3 units)
...
- **ENGL 519** - Ethnic Literatures of the United States (3 units)
- **ENGL 526** - Topics in Literature of the United States (3 units)
- **ENGL 550** - Queer Texts and Contexts (3 units)
- **ENGL 563** - Literature and Culture (3 units)
- **C LT 440** - African Literature (3 units)
- **C LT 445** - Modern Latin American Literature (3 units)
- **C LT 470** - Folk Literature (3 units)
- **C LT 513** - Nineteenth Century European Literature (3 units)
- **C LT 561** - Fiction (3 units)
- **C LT 580** - Concepts in Comparative Studies (3 units)
- **C LT 594** - Topics in Literature and the Arts (3 units)
- **C LT 595** - Literature and Aesthetics (3 units)
- **C LT 596** - Topics in Comparative Literature (3 units)
...
- **ENGL 573** - Techniques of the Novel (3 units)
- **ENGL 576A** - Literary Publishing and Editing Workshop A (3 units)
- **ENGL 576B** - Literary Publishing and Editing Workshop B (3 units)
- **ENGL 577** - Techniques of Screenwriting (3 units)
- **ENGL 579** - Topics in Creative Writing (3 units)
- **ENGL 580** - Writing of Poetry (3 units)
- **ENGL 581W** - Writing of Fiction (3 units)
- **ENGL 584W** - Writing Informal Essays (3 units)
